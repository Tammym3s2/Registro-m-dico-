...
|----|-----------|-------------|----------|------------|
| SP3-01 | Aggregation Pipeline Introduction | Implement MongoDB aggregation pipelines using `$match`, `$group`, and `$count` for statistical analysis of pet records | High | 3 pts |
| SP3-02 | Basic Analytics Reports | Create analytical reports for totals, counts, and grouped species statistics | High | 4 pts |
